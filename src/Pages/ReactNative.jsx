...
const ReactNativePage = () => {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg-primary)' }}>
          ...
          <div className="relative">
            ...
            <div className="space-y-8 md:space-y-12">
              {developmentPhases.map((phase, index) => (
                ...
                >
                  {/* Timeline dot */}
                  <div className="absolute left-1/2 transform -translate-x-1/2 md:left-1/2 md:translate-x-0 w-8 h-8 rounded-full bg-white border-4 border-blue-500 z-10"
                  ...
                  <div className={`w-full md:w-5/12 ${index % 2 === 0 ? 'md:pr-12 md:text-right' : 'md:pl-12'}`}>
                    <div className="rounded-2xl p-6 md:p-8 border transition-all duration-300"
                      ...
                      <h3 className="text-xl font-bold mb-2" style={{ color: 'var(--text-primary)' }}>{phase.title}</h3>
                      ...
                      <div>
                        <h4 className="font-semibold mb-2" style={{ color: 'var(--text-primary)' }}>Deliverables:</h4>
                        <ul className="space-y-2">
      ...
      <section id="packages" className="py-16 md:py-20" style={{ background: 'var(--bg-primary)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4" style={{ color: 'var(--text-primary)' }}>
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            {packages.map((pkg, index) => (
              <div
                key={index}
                className={`relative rounded-3xl overflow-hidden transition-all duration-300 ${index === 1 ? 'transform md:scale-105 md:-translate-y-4 shadow-2xl' : 'shadow-xl'
                  }`}
            ...
            <div className="relative">
              <div className="rounded-3xl p-6 md:p-8 border" style={{ background: 'var(--bg-card)', borderColor: 'var(--border-subtle)' }}>
                <div className="grid grid-cols-2 gap-4">
                  <div className="rounded-2xl p-6 text-center shadow-md border" style={{ background: 'var(--bg-card-hover)', borderColor: 'var(--border-subtle)' }}>
                    <div className="text-3xl font-bold text-blue-600 mb-2">80%</div>
                    <div className="text-sm" style={{ color: 'var(--text-secondary)' }}>Code Sharing</div>
                  </div>
                  <div className="rounded-2xl p-6 text-center shadow-md border" style={{ background: 'var(--bg-card-hover)', borderColor: 'var(--border-subtle)' }}>
                    <div className="text-3xl font-bold text-green-600 mb-2">40%</div>
                    <div className="text-sm" style={{ color: 'var(--text-secondary)' }}>Cost Savings</div>
                  </div>
                  <div className="rounded-2xl p-6 text-center shadow-md border" style={{ background: 'var(--bg-card-hover)', borderColor: 'var(--border-subtle)' }}>
                    <div className="text-3xl font-bold text-purple-600 mb-2">30%</div>
                    <div className="text-sm" style={{ color: 'var(--text-secondary)' }}>Faster Development</div>
                  </div>
                  <div className="rounded-2xl p-6 text-center shadow-md border" style={{ background: 'var(--bg-card-hover)', borderColor: 'var(--border-subtle)' }}>
                    <div className="text-3xl font-bold text-yellow-600 mb-2">95%</div>
                    <div className="text-sm" style={{ color: 'var(--text-secondary)' }}>Native Performance</div>
                  </div>
                </div>
